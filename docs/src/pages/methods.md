...
| ------------------------------ | ---------------------------------------------------------------------------------- | --------- | -------------------------------------------------------------------------------------------------------------- |
| removeOption(event, option, false) | **event**: eventEmitter \| null <br />**option**: object<br /> **closeModal**: boolean | undefined | `event` used to stop propagation                                                                               |
| dropDown('toggle')             | **string**: open\|close\|toggle                                                    | undefined | one of _open_, _close_ or _toggle_                                                                             |
| addOption(option)                  | **option**: object                                                                   | true      |                                                                                                                |
...
| isSelected(option)               | **option**: object                                                                   | boolean   |                                                                                                                |
| searchResults()                | -                                                                                  | array     | returns array of options matching `/option.label/i` regex, if `searchBy` prop is used - matches against it's value |
